...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("choice_distribution", postgresql.JSONB(), server_default=sa.text("'{}'::jsonb"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("choice_sequence", postgresql.JSONB(), server_default=sa.text("'[]'::jsonb"), nullable=False),
